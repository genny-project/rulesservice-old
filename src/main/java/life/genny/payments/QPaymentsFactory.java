...
public class QPaymentsFactory {
	...
	public QPaymentsFactory(String qwandaServiceUrl, String token, Map<String, Object> decodedMapToken, String realm, EventBus eventBus) {
	...
	public QPaymentsProvider getMessageProvider(QPaymentsServiceProvider paymentsServiceProvider)
	{
		...
		case ASSEMBLY:
			paymentsProvider = new QAssemblyPaymentsManager(this.qwandaServiceUrl, this.token, this.decodedMapToken, this.realm, this.eventBus);
		default:
			paymentsProvider = new QAssemblyPaymentsManager(this.qwandaServiceUrl, this.token, this.decodedMapToken, this.realm, this.eventBus);
		}
